...
class TestDinoV3EncoderGaz:
    def test_single_image_encode(self, dino_encoder, image_left):
    ...
    def test_mask_encoding(self, dino_encoder, mask_left, encoded_features):
    ...
    def test_cosine_similarity(self, dino_encoder, example_image, image_left, mask_left):
    ...
    def test_target_size_computation(self, dino_encoder, image_left, example_image):
    ...
    def test_resize_transform(self, dino_encoder, image_left):
